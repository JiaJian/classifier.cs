...
namespace classifier.cs.Models {
	class BayesClassifier {
		/**
		 * @param directory The directory.
		 * @param k The top k nearest neighbours (kNN).
		 * @param soundFeature
		 * @param timeUse
		 * @param spatialUse
		 */
		public void ClassifyLeaveOneOut(string directory, int k = 8, int soundFeature = 1, int timeUse = 0, int spatialUse = 0) {
